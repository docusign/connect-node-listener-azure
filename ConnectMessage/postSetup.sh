...
connectionstr=$(az servicebus namespace authorization-rule keys list --resource-group $rg --namespace-name Connect-Events-DS --name RootManageSharedAccessKey --query primaryConnectionString --output tsv)
